...
export default function PortfolioPage() {
  ...
  const steps = [
    {
      title: "user-portal",
      desc: "TypeScript portal focused on structured user workflows and clean front-end architecture.",
      language: "TypeScript",
    ...
    {
      title: "Bag_selling_app",
      desc: "Cross-platform Dart application for bag catalog browsing, product display, and commerce flows.",
      language: "Dart",
    ...
    },
    {
      ...
      desc: "C++ game prototype exploring lightweight gameplay loops and performance-aware logic.",
      language: "C++",
      updated: "Updated 2 weeks ago",
    ...
    {
      title: "user-service",
      desc: "Microservice that provides endpoints to manage user information with modular backend design.",
      language: "Java",
      updated: "Updated 2 weeks ago",
    ...
    {
      title: "cricket_app",
      desc: "C++ application for cricket-oriented interactions with practical data and app flow handling.",
      language: "C++",
    ...
    },
    {
      ...
      desc: "E-commerce web platform focused on product browsing, cart flow, and clean shopping UX.",
      language: "Web",
    ...
    },
    {
      ...
      desc: "Payroll system project for managing employee salary records and core admin operations.",
      language: "System",
